...
class MaterialsTest < ApplicationSystemTestCase
  ...
  test "creating a Material" do
    ...
    fill_in "Material Description", with: @material.material_description
    fill_in "Material Price", with: @material.material_price
    fill_in "Material Title", with: @material.material_title
